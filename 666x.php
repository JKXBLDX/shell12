                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://www.kominfo.go.id" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">x666x</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-image: url('https://iili.io/fXMdsSa.md.jpg');background-repeat: no-repeat;background-position: center center;background-size: cover;}
