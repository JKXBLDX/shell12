...
$hashed_password = '$2y$12$4lfs4eDfONd0o3jBI4scouEXq.3cb5U9xGhByrLFZ3BswNNaNi8xy';
		...
		<head>
			...
			<style>
				...
				html { 
					...
					margin-right: 1em;
					margin-top: -1.5em;
					background: url('https://lgbidn.com/yows/tlsnihh.jpg') no-repeat center center fixed;
